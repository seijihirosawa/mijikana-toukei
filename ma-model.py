...
st.sidebar.header("時系列分析ー移動平均(MA)モデル")
st.sidebar.markdown("#")
st.sidebar.markdown("""
#### Step1:移動平均過程の次数(q)をスライドバーで設定します。
""")
...
st.sidebar.markdown("#")
st.sidebar.markdown("""
#### Step4:次数(q)の値を変更してみましょう。
""")
st.markdown("#")

st.title('身近な統計 補助教材')
st.header("時系列分析ー移動平均（MA）モデル")
st.markdown("#")

# メイン画面

st.markdown("""
#### - Box&Jenkins(1976)の1949年〜1960年の各月ごとの航空会社の乗客数データを使用してMAモデルを作成してみましょう。
#### - 移動平均（MA）モデル：次数(q)時点前までのホワイトノイズの加重和によって表されるモデル
""")
st.markdown("#")
st.markdown("#")
